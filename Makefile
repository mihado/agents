...
help:
	...
	@echo "make vendor         Fetch vendored skills to stage (apm vendor fetch)"
	@echo "make vendor-review  Review staged skill diffs with skillspector (apm vendor review --skillspector)"
	@echo "make vendor-audit   Audit live skill tree with skillspector (apm vendor audit --skillspector)"
	@echo "make vendor-accept  Promote stage to live (apm vendor accept)"
	@echo "make vendor-reject  Remove a skill from stage (apm vendor reject <skill>)"
	@echo "make vendor-remove  Remove a skill from live tree (apm vendor remove <skill>)"
